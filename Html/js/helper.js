 ...
 */
function g_customizeResponse(city_str, input_str,  creativity_str, babynames_str){
	var 
		babynames_array;
	
	babynames_array = babynames_str.split(",");
	console.log(babynames_array);
	
	//Populate results and add listener
	populateResults(babynames_array);
	
	//Add favorite listeners
	addListenerToResults();
	
	//Add default showing value
